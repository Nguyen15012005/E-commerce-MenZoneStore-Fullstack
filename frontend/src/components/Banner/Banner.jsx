    ...
    <div className='min-h-[550px] flex justify-center items-center py-12 sm:py-0'>
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
            ...
            {/* text details section section */}
            <div className="flex flex-col justify-center gap-6 sm:pt-0">
                <h1 data-aos="fade-up" className='text-3xl sm:text-4xl font-bold'>Winter Sale Upto 50% Off</h1>
                <p data-aos="fade-up" className='text-sm text-gray-500 tracking-wide leading-5'>Thông tin thời trang uy tín và nổi bật của các thương hiệu nổi tiếng. Giới thiệu các xu hướng, bộ sưu tập, phụ kiện nổi bật hiện nay trên thế giới duy nhất ...</p>
